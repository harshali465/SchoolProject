      ...
      var a = r(4165),
        ...
        f = function () {
          var e = (0, p.s0)(),
            ...
            Z = function (e) {
              var s = e.target,
                r = s.name,
                a = s.value;
              j((0, o.Z)((0, o.Z)({}, f), {}, (0, l.Z)({}, r, a)));
            },
            N = (function () {
              var s = (0, n.Z)(
                (0, a.Z)().mark(function s(r) {
                  var n, l, o;
                  return (0, a.Z)().wrap(
                    function (s) {
                      for (;;)
                        switch ((s.prev = s.next)) {
                          case 0:
                            if ((r.preventDefault(), 0 !== (n = y(f)).length)) {
                              s.next = 20;
                              break;
                            }
                            return (
                          ...
                          case 13:
                            (s.prev = 13),
                              (s.t0 = s.catch(3)),
                              console.error("signup failed", s.t0);
                          case 16:
                            j({
                              name: "",
                              email: "",
            ...
            y = function (e) {
              var s = [];
              return (
                e.name.trim() || (s[0] = "Name is required"),
                e.email.trim()
                  ? b(e.email) || (s[2] = "Invalid email format")
                  : (s[1] = "Email is required"),
                e.password
                  ? e.password.length < 8 &&
                    (s[4] = "Password must be at least 8 characters")
                  : (s[3] = "Password is required"),
                e.password !== e.passwordConfirm &&
                  (s[5] = "Passwords do not match"),
                s
              );
            },
            b = function (e) {
          ...
          return (0, x.jsx)("div", {
            ...
            children: (0, x.jsx)(t.KB, {
              children: (0, x.jsx)(t.rb, {
                className: "justify-content-center",
                children: (0, x.jsx)(t.b7, {
                  md: 9,
                  lg: 7,
                  xl: 6,
                  children: (0, x.jsx)(t.xH, {
                    className: "mx-4",
                    children: (0, x.jsx)(t.sl, {
                      className: "p-4",
                      children: (0, x.jsxs)(t.lx, {
                        children: [
                          (0, x.jsx)("h1", { children: "Register" }),
                          (0, x.jsx)("p", {
                          ...
                          (0, x.jsx)("div", {
                            ...
                            style: { color: "#ff3333" },
                            children:
                              C[0] && (0, x.jsx)("div", { children: C[0] }),
                          }),
                          (0, x.jsxs)(t.YR, {
                            className: "",
                            children: [
                              (0, x.jsx)(t.wV, { children: "@" }),
                              (0, x.jsx)(t.jO, {
                                placeholder: "Email",
                                autoComplete: "email",
                                name: "email",
                          ...
                          (0, x.jsx)("div", {
                            ...
                            children:
                              C[1] ||
                              (C[2] &&
                                (0, x.jsx)("div", { children: C[1] || C[2] })),
                          }),
                          (0, x.jsxs)(t.YR, {
                            className: "",
                            children: [
                              (0, x.jsx)(t.wV, {
                                children: (0, x.jsx)(d.Z, { icon: u.U }),
                              }),
                              (0, x.jsx)(t.jO, {
                                type: "password",
                          ...
                          (0, x.jsx)("div", {
                            ...
                            style: { color: "#ff3333" },
                            children:
                              C[5] && (0, x.jsx)("div", { children: C[5] }),
                          }),
                          (0, x.jsx)("div", {
                            className: "d-grid",
                            children: (0, x.jsx)(t.u5, {
                              color: "success",
                              onClick: N,
...
//# sourceMappingURL=289.cfd44cf4.chunk.js.map
