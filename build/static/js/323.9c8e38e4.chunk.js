    ...
    323: function (e, t, n) {
      ...
      t.default = function () {
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          ...
                          (e.next = 4),
                          u.Z.get("http://18.118.42.224:3001/api/v1/users", {
                            headers: {
        ...
        var t = (0, o.s0)(),
              ...
              (0, i.Z)().mark(function e(t) {
                ...
                return (0, i.Z)().wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        !1 === (n = (0, c.Z)(p))[t].selected
                          ? O([].concat((0, c.Z)(S), [n[t]._id]))
                          : O(function (e) {
                  ...
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        ...
                        case 4:
                          (t = e.sent), console.log(t.data), (e.next = 11);
                          break;
                        case 8:
                          (e.prev = 8),
                            (e.t0 = e.catch(1)),
          ...
          ie = (ce - 1) * $,
          ae = ie + $,
          le = (f.slice(ie, ae), Math.ceil(f.length / $));
        return (0, h.jsxs)("div", {
          children: [
            (0, h.jsxs)(d.Tk, {
              backdrop: "static",
            ...
            (0, h.jsxs)("div", {
              ...
              children: [
                ...
                (0, h.jsxs)("div", {
                  className: "filters d-flex justify-content-between",
                  children: [
                    (0, h.jsx)("input", {
                    ...
                    (0, h.jsxs)("select", {
                      ...
                      children: [
                        (0, h.jsx)("option", { value: "", children: "Class" }),
                        (0, h.jsx)("option", { children: "1st" }),
                        (0, h.jsx)("option", { children: "2nd" }),
                        (0, h.jsx)("option", { children: "3rd" }),
                        (0, h.jsx)("option", { children: "4th" }),
                        (0, h.jsx)("option", { children: "5th" }),
                      ],
                    }),
                    (0, h.jsxs)("select", {
                      className: "form-select",
                      ...
                      children: [
                        (0, h.jsx)("option", { value: "", children: "Type" }),
                        (0, h.jsx)("option", { children: "Class T" }),
                        (0, h.jsx)("option", { children: "Assist T" }),
                        (0, h.jsx)("option", { children: "Subject T" }),
                      ],
                    }),
                    (0, h.jsxs)("select", {
                      className: "form-select",
                      ...
                      children: [
                        ...
                        (0, h.jsx)("option", { children: "Primary" }),
                        (0, h.jsx)("option", { children: "Pre Primary" }),
                        (0, h.jsx)("option", { children: "Secondary" }),
                      ],
                    }),
                  ],
                }),
              ...
              children: [
                ...
                (0, h.jsx)("button", {
                  ...
                  onClick: function () {
                        ...
                        .concat(
                          e.map(function (e) {
                            return [
                              ...
                              e.class,
                              e.division,
                              e.behaviousPoints.positivePoints -
                    ...
                    (s.href = c),
                      (s.download = "selected_teachers.csv"),
                    ...
                    .filter(function (e) {
                      return (function (e) {
                        return (
                          ...
                          e.class.toLowerCase().includes(R.toLowerCase()) &&
                          ("" === _ || e.teachertype === _) &&
                          ("" === F || e.section === F)
                        );
                      })(e);
            ...
            (0, h.jsx)("div", {
              ...
              children: (0, h.jsxs)(d.E7, {
                ...
                children: [
                  ...
                  Array.from({ length: le }, function (e, t) {
                    return (0, h.jsx)(
                      d.tn,
                      {
                        active: ce === t + 1,
                  ...
                  (0, h.jsx)(d.tn, {
                    ...
                    disabled: ce === Math.ceil(f.length / $),
                    children: "Next",
                  }),
                  (0, h.jsxs)("div", {
                    className: "d-flex",
...
//# sourceMappingURL=323.9c8e38e4.chunk.js.map
