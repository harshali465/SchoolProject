    ...
    2835: function (e, t, n) {
      ...
      t.default = function () {
        ...
        var t = (0, o.s0)(),
              ...
              (0, i.Z)().mark(function e(t) {
                ...
                return (0, i.Z)().wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        !1 === (n = (0, s.Z)(f))[t].selected
                          ? O([].concat((0, s.Z)(g), [n[t]._id]))
                          : O(function (e) {
          ...
          ae = (ce - 1) * ee,
          le = ae + ee,
          oe = (v.slice(ae, le), Math.ceil(v.length / ee));
        return (0, h.jsxs)("div", {
          children: [
            (0, h.jsxs)(d.Tk, {
              backdrop: "static",
              ...
              children: [
                (0, h.jsx)(d.p0, {
                  children: (0, h.jsx)(d.fl, {
                    ...
                    children: "Delete schools",
                  }),
                }),
                (0, h.jsx)(d.sD, {
                  children: "Are you sure you wish to delete the schools?",
                }),
                (0, h.jsxs)(d.Ym, {
                  children: [
                    (0, h.jsx)(d.u5, {
              ...
              children: [
                ...
                (0, h.jsx)("button", {
                  ...
                  onClick: function () {
                    ...
                    (c.href = s),
                      (c.download = "selected_students.csv"),
                    ...
                    .filter(function (e) {
                      return (function (e) {
                        return (
                          ("" === Q || e.class === Q) &&
                          ("" === _ || e.division === _) &&
                          ("" === P || e.numberOfStudents >= parseInt(P)) &&
                          ("" === H || e.numberOfStudents <= parseInt(H))
                        );
                      })(e);
                    })
                    .map(function (e, n) {
              ...
              children: (0, h.jsxs)(d.E7, {
                ...
                children: [
                  ...
                  (0, h.jsx)(d.tn, {
                    ...
                    disabled: ce === Math.ceil(v.length / ee),
                    children: "Next",
                  }),
                  (0, h.jsxs)("div", {
                    className: "d-flex",
