    ...
    try {
      ...
      if (editStudent) {
        setFormData({
          ...
          house: editStudent.house,
          phoneNumber: editStudent.itsNo,
          studentId: editStudent.studentId,
          division: editStudent.division,
          mentor: editStudent.mentor,
          siblings: [],
          fatherFirstName: editStudent.familyDetails.fatherFirstName,
          fatherLastName: editStudent.familyDetails.fatherLastName,
          fatherPhoneNumber: editStudent.familyDetails.fatherPhone,
          fatherEmailAddress: editStudent.familyDetails.fatherEmail,
          motherFirstName: editStudent.familyDetails.motherFirstName,
          motherLastName: editStudent.familyDetails.motherLastName,
          motherPhoneNumber: editStudent.familyDetails.motherPhone,
          motherEmailAddress: editStudent.familyDetails.motherEmail,
