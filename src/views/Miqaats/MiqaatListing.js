  ...
  return (
    <div>
      ...
      >
        ...
        <CModalBody>Are you sure you wish to delete this Miqaat?</CModalBody>
        <CModalFooter>
          <CButton
            color="secondary"
            onClick={() => {
      ...
      <div className="mb-2">
        <div className="row pb-5">
          <div className="col-md-6 ">
            <div className="display-6 pb-3 float-end">Miqaat listing</div>
          </div>
      ...
      <table className="table table-bordered">
        <thead>
          <tr>
            ...
            <th className="text-center">Name of Miqaat</th>
            <th className="text-center">Description</th>
            <th className="text-center">Miqaat Date(English)</th>
            <th className="text-center">Miqaat Date(arabic)</th>
          ...
          {dummystudents
            ...
            .map((student, index) => (
              <tr key={index}>
                ...
                <td className="text-center align-middle">dummy date</td>
                <td className="text-center align-middle">dummy date</td>
                <td className="text-center align-middle">
