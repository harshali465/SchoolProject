...
const AttendanceListing = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "day_type",
      render: (_, record) =>
        record?.day_type?.type
          ? record.day_type.type.charAt(0).toUpperCase() + record.day_type.type.slice(1)
          : "-"
    },
            ...
            <div className="card">
              <div className="card-header d-flex align-items-center justify-content-between flex-wrap pb-0">
                ...
                <div className="d-flex align-items-center flex-wrap">
                  ...
                  <div className=" mb-3 me-2 position-relative notification-box">
  <select
           className="form-control form-select date-range-leave"

    value={dayTag}
    onChange={(e) => setDayTag(e.target.value)}
  >
    <option value="">Select Day Type</option>
    {dayTagOptions.map((opt) => (
...
<div className=" mb-3 me-2 position-relative notification-box">
  ...
  >
    <option value="">Attendance Tag</option>
    {attendanceTagOptions.map((opt) => (
      <option key={opt.value} value={opt.value}>
        {opt.label}
      </option>
    ))}
