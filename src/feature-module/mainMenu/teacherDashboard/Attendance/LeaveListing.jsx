      ...
      render: (_, record) => (
        ...
        {(record?.is_approved || record?.is_rejected || record?.is_withdrawn) && (
          <button
            ...
            onClick={() =>
              navigate("/teacher/leave/view", { state: { id: record?._id } })
            }
          >
        ...
        {!record?.is_withdrawn && !record?.is_approved && !record?.is_rejected && (
          <button
            ...
            onClick={() =>
              navigate("/teacher/leave/edit", { state: { id: record?._id } })
            }
          >
          ...
          <div className="content">
              ...
              <div className="d-flex my-xl-auto right-content align-items-center flex-wrap">
                <div className="mb-2">
                  <Link
                    ...
                    to={all_routes.teacher.leaveRequest}
                  >
            ...
            <div className="card">
              <div className="card-header d-flex align-items-center justify-content-between flex-wrap pb-0">
                <h4 className="mb-3">Teacher Leave List</h4>
...
export default LeaveListingteacher;
