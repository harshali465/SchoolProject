...
const CouponRequest = () => {
  ...
  const getCoupon = async () => {
    ...
    try {
        const res = await axios.get(
            ...
            }/api/v1/behaviorpoint/coupon-approval/user/${localStorage.getItem("userId")}?academicYearId=${
  ...
  const getCouponValue = async () => {
    try {
      const res = await axios.get(
        `${process.env.REACT_APP_DEV_BASE_URL}/api/v1/behaviorpoint/coupons/?coupon_for=teacher&academicYearId=${
          academicYearId == authState?.startYearId
            ? academicYearId
            : authState?.startYearId
        }`,
            ...
            <div className="content p-3 ">
              ...
              <div className="card-header coupon_responsive  rounded">
                      <div className="d-flex align-items-center">
                        ...
                        <h4 className="text-dark" style={{fontSize:"x-large"}}>Coupon Request Listing</h4>
                        </div>
                        
                        <div className="d-flex justify-content-end flex-wrap mt-3">
                      <div className="col-md-4  min-width  responsive-box">
                  <div style={{marginBottom:"0px"}} className="card bg-info-transparent border-3 border-white text-center p-3">
                    
                    
                    <div className="d-flex align-items-center justify-content-between text-default">
                              <h6 className="">
                              <FaCoins style={{marginRight:"5px"}}/>          Total Points Earned</h6>
                      <p>{points?.totalPoints > 0 ? points.totalPoints.toFixed(2) : '0'}
                      </p>
                    </div>
                  </div>
                      </div>    
                ...
                <div className="col-md-4 min-width responsive-box">
                  <div  style={{marginBottom:"0px"}} className="card bg-warning-transparent border-3 border-white text-center p-3">
                  
                   
                    <div className="d-flex align-items-center justify-content-between text-default">
 
                    <h6 className="">  <AccountBalanceWalletIcon fontSize="12px" style={{marginRight:"5px"}}/> Total Points Balance</h6>
                      <p>{points?.RemainingPoints > 0
