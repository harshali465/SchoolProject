...
const MyPoints = () => {
  ...
  const [readIds, setReadIds] = useState([]); // to store ids that were read on the frontend
  ...
  const exportToExcel = () => {
    ...
    saveAs(dataBlob, `Individual Teacher Points Details excel.xlsx`);
  };
  return (
    <>
      {/* Page Wrapper */}
        ...
        <div className="content content-two">
          ...
          <div className="d-md-flex d-block align-items-center justify-content-between mb-3">
            <div className="my-auto mb-2">
              <h3 className="page-title mb-1">
                Individual Teacher Points Details
              </h3>
            </div>
          ...
          <div className="bg-white p-3 border rounded-1 d-flex align-items-center justify-content-between flex-wrap mb-4 ">
            ...
            <div className="d-flex align-items-center flex-wrap gap-2">
              <div className="input-icon-start d-flex  me-2 position-relative gap-2 ">
                <DatePicker
                  selectsRange={true}
                  startDate={startDate}
                  endDate={endDate}
                  ...
                  >
                    ...
                    <AccordionDetails className="accordian-detail">
                      ...
                      <button
                        ...
                        onClick={() =>
                          navigate(
                            "/teacher/behaviour/assign-points/individual",
                            { state: { data: student } }
                          )
                        }
                      >
