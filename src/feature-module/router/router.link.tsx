...
import StudentDasboard from "../mainMenu/studentDashboard/StudentView";
...
import ClassRoom from "../mainMenu/studentDashboard/siblingList";
...
import LeaderBoard from "../mainMenu/studentDashboard/Behaviour/MainPage";
import AssignPoints from "../mainMenu/studentDashboard/Behaviour/Assign/AssignPointsListing";
import AssignPoint from "../mainMenu/studentDashboard/Behaviour/Assign/AssignPoint";
import CouponRequest from "../mainMenu/studentDashboard/Behaviour/CouponRequest";
import Report from "../mainMenu/studentDashboard/Behaviour/Report";
import MonthlyReport from "../mainMenu/studentDashboard/Behaviour/MonthlyReport";
import ViewReport from "../mainMenu/studentDashboard/ViewReport";
import MyPoints from "../mainMenu/studentDashboard/Behaviour/MyPoints";
import EditStudent from "../mainMenu/studentDashboard/EditStudent";
...
import LeaderBoardTeacher from "../mainMenu/teacherDashboard/Behaviour/MainPage";
import AssignPointsTeacher from "../mainMenu/teacherDashboard/Behaviour/Assign/AssignPointsListing";
import AssignPointTeacher from "../mainMenu/teacherDashboard/Behaviour/Assign/AssignPoint";
import CouponRequestTeacher from "../mainMenu/teacherDashboard/Behaviour/CouponRequest";
import ReportTeacher from "../mainMenu/teacherDashboard/Behaviour/Report";
import MonthlyReportTeacher from "../mainMenu/teacherDashboard/Behaviour/MonthlyReport";
import ViewReportTeacher from "../mainMenu/teacherDashboard/ViewReport";
import MyPointsTeacher from "../mainMenu/teacherDashboard/Behaviour/MyPoints";
import EditStudentTeacher from "../mainMenu/teacherDashboard/EditStudent";
import ViewClass from "../mainMenu/teacherDashboard/Behaviour/Assign/ViewClass";
import SingleView from "../mainMenu/teacherDashboard/Behaviour/SingleView";
import ClassWise from "../mainMenu/teacherDashboard/Behaviour/Assign/ClassWise";
import EditProfile from "../mainMenu/studentDashboard/EditProfile";
import EditPassword from "../mainMenu/studentDashboard/EditPassword";
import EditProfileTeacher from "../mainMenu/teacherDashboard/EditProfile";
import EditPasswordTeacher from "../mainMenu/teacherDashboard/EditPassword";
import LeaveListing from "../mainMenu/studentDashboard/Attendance/LeaveListing";
import AttendanceListing from "../mainMenu/studentDashboard/Attendance/AttendanceListing";
import LeaveRequest from "../mainMenu/studentDashboard/Attendance/LeaveRequest";
import LeaveListingteacher from "../mainMenu/teacherDashboard/Attendance/LeaveListing";
import AttendanceListingteacher from "../mainMenu/teacherDashboard/Attendance/AttendanceListing";
import TodayAttendanceteacher from "../mainMenu/teacherDashboard/Attendance/TodayAttendance";
import UpdateAttendanceteacher from "../mainMenu/teacherDashboard/Attendance/UpdateAttendance";
import LeaveRequestteacher from "../mainMenu/teacherDashboard/Attendance/LeaveRequest";
import Notification from "../mainMenu/teacherDashboard/Notification/Notification";
import NotificationStudent from "../mainMenu/studentDashboard/Notification/Notification";
import LeaveEdit from "../mainMenu/studentDashboard/Attendance/LeaveEdit";
import ViewLeave from "../mainMenu/studentDashboard/Attendance/ViewLeave";
import TimeTableListingStudent from "../mainMenu/studentDashboard/TimeTable/TimeTableListingStudent";
import TimeTableListing from "../mainMenu/teacherDashboard/TimeTable/TimeTableListing";
import ViewLeaveT from "../mainMenu/teacherDashboard/Attendance/ViewLeave";
import AttendanceListingteacherEdit from "../mainMenu/teacherDashboard/Attendance/AttendanceListingEdit";
import LeaveRequestteacherEdit from "../mainMenu/teacherDashboard/Attendance/LeaveEdit";
import AttendanceListingView from "../mainMenu/studentDashboard/Attendance/AttendanceView";
import DayAttedance from "../mainMenu/teacherDashboard/Attendance/DayAttedance";
import AssignPointUnique from "../mainMenu/teacherDashboard/Behaviour/Assign/AssignPointunique";
import AssignPointUniqueStudent from "../mainMenu/studentDashboard/Behaviour/Assign/AssignPointunique";
...
export const studentRoute = [
  ...
  {
    path: routes.behaviour.leaderboard,
    element: <LeaderBoard />,
  },
  ...
  // assignpointsuniquestudent
  
  {
    path: routes.assignpointsuniquestudent,
    element: <AssignPointUniqueStudent />,
    route: Route,
  },
  {
  ...
  {
    path: routes.LeaveListing,
    element: <LeaveListing />,
    route: Route,
  },
  {
    path: routes.timetable,
    element: < TimeTableListingStudent/>,
    route: Route,
  },
  ...
  {
    path: routes.noification,
    element: <NotificationStudent />,
    route: Route,
  },
  
  {
    path: routes.AttendanceListing,
    element: <AttendanceListing />,
    route: Route,
  },
  {
    path: routes.AttendanceListingView,
    element: <AttendanceListingView />,
    route: Route,
  },
  
  {
    path: routes.behaviour.assignPoints,
    element: <AssignPoints />,
    route: Route,
  },
  {
  ...
  {
    path: routes.assignPoints,
    element: <AssignPoint/>,
    route: Route,
  },
  
 {
   path: routes.coupon_request_student,
...
export const publicRoutes = [
  {
    path: routes.teacher.dayAttendance,
    element: <DayAttedance />,
    route: Route,
  },
  {
    path: routes.teacher.editLeave,
    element: <LeaveRequestteacherEdit />,
    route: Route,
  },
  {
    path: routes.teacher.AttendanceListingedit,
    element: <AttendanceListingteacherEdit />,
    route: Route,
  },
  {
    path: routes.teacher.viewLeave,
    element: <ViewLeaveT />,
    route: Route,
  },
  // teacher
  {
    path: routes.teacher.behaviour.mypoints,
    element: <MyPointsTeacher />,
    route: Route,
  },
  {
    path: routes.teacher.timetable,
    element: <TimeTableListing/>,
    route: Route,
  },
  {
    path: routes.teacher.behaviour.assignPoints,
    element: <AssignPointsTeacher />,
    route: Route,
  },
  {
    path: routes.teacher.assignPointsIndividual,
    element: <AssignPointUnique />,
    route: Route,
  },
  
  {
    path: routes.teacher.behaviour.ViewClass,
    element: <ViewClass />,
    route: Route,
  },
  ...
  {
    path: routes.teacher.assignPoints,
    element: <AssignPointTeacher/>,
    route: Route,
  },
  ...
  {
    path: routes.teacher.noification,
    element: <Notification/>,
    route: Route,
  },
 {
   path: routes.teacher.coupon_request_student,
   element: <CouponRequestTeacher />,
   route: Route,

  },
  
  {
    path: routes.teacher.singleView,
    element: <SingleView />,
    route: Route,
   ...
   {
    path: routes.teacher.EditProfileTeacher,
   ...
   {
    path: routes.teacher.EditPasswordTeacher,
    element: <EditPasswordTeacher />,
    route: Route,
   ...
   {
    path: routes.teacher.LeaveListing,
    element: <LeaveListingteacher />,
    route: Route,
 
   },
   
   {
    path: routes.teacher.AttendanceListing,
    element: <AttendanceListingteacher />,
    route: Route,
 
   },
   {
    path: routes.teacher.TodayAttendance,
    element: <TodayAttendanceteacher />,
    route: Route,
 
   },
   {
    path: routes.teacher.UpdateTodayAttendance,
    element: <UpdateAttendanceteacher />,
    route: Route,
 
   },
   {
    path: routes.teacher.leaveRequest,
    element: <LeaveRequestteacher />,
    route: Route,
  ...
  {
    path: routes.teacher.behaviour.leaderboard,
    element: <LeaderBoardTeacher />,
  },
