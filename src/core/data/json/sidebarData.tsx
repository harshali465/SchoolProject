    ...
    submenuItems: [
      ...
      },
      {
        ...
        submenuItems: [
                  {
                    label: "Dashboard",
                    link: routes.behaviour.leaderboard,
                 
                  },
          {
            label: "Assign Points",
            link: routes.behaviour.assignPoints
          },
                  {
                    label: "Coupon ",
                    
                    link: routes.coupon_request_student,
      ...
      },
      {
        ...
        submenuItems: [
                  {
                    label: "Leave",
                    link: routes.LeaveListing,
                 
                  },
          {
            label: "Attendance",
            link: routes.AttendanceListing
          },
    ...
    submenuItems: [
    
      {
        ...
        submenuItems: [
                  {
                    label: "Dashboard",
                    link: routes.teacher.behaviour.leaderboard,
                    // subLink1: routes.addStudent,
                    // subLink2: routes.editStudent,
                  },
          {
            label: "Assign Points",
            link: routes.teacher.behaviour.assignPoints
          },
                  {
                    label: "Coupon ",
                    
                    link: routes.teacher.coupon_request_student,
                    // subLink1: routes.studentLibrary,
                    // subLink2: routes.studentResult,
                    // subLink3: routes.studentFees,
                    // subLink4: routes.studentLeaves,
      ...
      },
      {
        ...
        submenuItems: [
                  {
                    label: "Leave",
                    link: routes.teacher.LeaveListing,
                  },
          {
            label: "Attendance",
            link: routes.teacher.AttendanceListing
          },
          {
            label: "Day Attendance",
            link: routes.teacher.dayAttendance
                      ...
                      submenuItems: [
                        {
                          ...
                          link: routes.teacher.TodayAttendance
                        },
                        {
                          label: "Update Past Attendance",
                          link: routes.teacher.UpdateTodayAttendance
                        },
                      ],
                    },
      ...
      },
      {
        ...
        icon: "ti ti-bell",
       moduleName: 'Notification',
        link: routes.teacher.noification,
      },
      {
        label: "Time Table",
        icon: "ti ti-layout-distribute-vertical",
